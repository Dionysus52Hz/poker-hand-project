...
for i in range(NUM_OF_EXECUTIONS):
    ...
    result.append(
        f1_score(Y_predicted, Y_test, average="macro")
    )  # F1-macro dung cho tap du lieu mat can bang
    ...
    if i == NUM_OF_EXECUTIONS - 1:
        ...
        create_comparative_table(
            test_class_counts_dict, pred_class_counts_dict, "bayes_comparison_table.png"
        )
